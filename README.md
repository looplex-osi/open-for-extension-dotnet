...
`Looplex.OpenForExtension` is available and ready for use on dotnet projects by running:
...
1. Create and publish packages on nuget.
1. Confirm if the package is available in nuget as the latest version.
